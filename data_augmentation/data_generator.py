...
class DataGenerator(object):
    ...
    def __init__(self, save_path):
        ...
        self.missing_prob = 1.0
        self.selection_prob = 0.0
        self.redundant_prob = 1.0
        ...
        self.extra_candidate = json.load(open(self.extra_candidate_path, 'r', encoding='utf-8'))
        self.confusion_pronounce = json.load(open(self.confusion_pronounce_path, 'r', encoding='utf-8'))
        self.confusion_shape = json.load(open(self.confusion_shape_path, 'r', encoding='utf-8'))
...
def main(args):
    if args.data_path.endswith('txt'):
        data = [[idx, line.strip().split()[1]] for idx, line in enumerate(open(args.data_path, 'r', encoding='utf-8').readlines())]
        # print(data)
